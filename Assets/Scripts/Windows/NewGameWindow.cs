...
public class NewGameWindow : GenericWindow {
	...
	public void CheckExitGame() {
		...
		if (result ["statusRequest"] == "True") {
			...
			bool goToHome = (gameControl.userA == gameControl.username && gameControl.gameTypeA == "randomGame") ||
				(gameControl.userB == gameControl.username && gameControl.gameTypeB == "randomGame");
